...
staticCfg.root = sitePath;
staticCfg.name = staticCfg.name || 'default';
var b = new release(staticCfg);
...
b.build(function(prjCfg){
    ...
    if(staticCfg.releaseHTML){
        ...
        pandora.init(app, appCfg,staticCfg);
        ...
        server.on('listening',function(e){
            ...
            async.map(routes,function(file,next){
                ...
                //var fileName = nodePath.basename(file,'.js');
                //从注释获取文件名
